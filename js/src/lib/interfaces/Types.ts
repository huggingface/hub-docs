...
export const ALL_PIPELINE_TYPES = Object.keys(
	PipelineType
) as (keyof typeof PipelineType)[];
...
export const MODALITIES = ["nlp", "audio", "cv", "other"] as const;
...
export const PIPELINE_TAG_MODALITIES: Record<
...
export const PIPELINE_COLOR: {
	[key in keyof typeof PipelineType]?:
		| "blue"
		| "green"
		| "indigo"
		| "orange"
