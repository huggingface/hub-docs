...
const MAPPING_EN: PerLanguageMapping = new Map([
	...
	[
		"fill-mask",
		[`Paris is the <mask> of France.`, `The goal of life is <mask>.`],
	],
	[
		"sentence-similarity",
		[
...
const MAPPING_RU: PerLanguageMapping = new Map([
	...
	[
		"text-generation",
		[`Меня зовут Жюльен и`, `Меня зовут Томас и мой основной`, `Однажды`],
	],
...
const MAPPING_IT: PerLanguageMapping = new Map([
	...
	[
		"translation",
		[`Mi chiamo Wolfgang e vivo a Berlino`, `Mi chiamo Sarah e vivo a Londra`],
	],
	[
		"summarization",
		[
	...
	[
		"fill-mask",
		[`Roma è la <mask> d'Italia.`, `Lo scopo della vita è <mask>.`],
	],
	[
		"sentence-similarity",
		[
...
const MAPPING_BN: PerLanguageMapping = new Map([
	...
	[
		"translation",
		[`আমার নাম জাহিদ, আমি রংপুরে বাস করি।`, `আপনি কী আজকে বাসায় আসবেন?`],
	],
	[
		"summarization",
		[
	...
	[
		"text-generation",
		[`আমি রতন এবং আমি`, `তুমি যদি চাও তবে`, `মিথিলা আজকে বড্ড`],
	],
...
const MAPPING_SI: PerLanguageMapping = new Map([
	[
		"translation",
		[`සිංහල ඉතා අලංකාර භාෂාවකි.`, `මෙම තාක්ෂණය භාවිතා කරන ඔබට ස්තූතියි.`],
	],
