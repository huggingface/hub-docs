...
<InferenceSnippet
    ...
    providersMapping={ {"fal-ai":{"modelId":"Tongyi-MAI/Z-Image","providerModelId":"fal-ai/z-image/base"},"hf-inference":{"modelId":"black-forest-labs/FLUX.1-dev","providerModelId":"black-forest-labs/FLUX.1-dev"},"nscale":{"modelId":"stabilityai/stable-diffusion-xl-base-1.0","providerModelId":"stabilityai/stable-diffusion-xl-base-1.0"},"replicate":{"modelId":"enhanceaiteam/Flux-uncensored","providerModelId":"black-forest-labs/flux-dev-lora"},"together":{"modelId":"black-forest-labs/FLUX.1-dev","providerModelId":"black-forest-labs/FLUX.1-dev"},"wavespeed":{"modelId":"Tongyi-MAI/Z-Image-Turbo","providerModelId":"wavespeed-ai/z-image/turbo"},"zai-org":{"modelId":"zai-org/GLM-Image","providerModelId":"glm-image"}} }
/>
