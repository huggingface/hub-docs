...
| [fast-agent](https://fast-agent.ai/)                                                                            | Open-source LLM framework for building production applications | [Official docs](https://fast-agent.ai/models/llm_providers/#hugging-face)                                     |
...
- [fast-agent](https://fast-agent.ai/) - Flexible framework building MCP/ACP powered Agents, Workflows and evals([Official docs](https://fast-agent.ai))
