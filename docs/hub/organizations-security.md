...
- By [verifying an email domain](./organizations-managing#organization-domain-name) for your organization, you can view the email addresses of members with a matching email domain.
