...
Similarly to the Team or Enterprise subscription, PRO subscriptions are billed like a typical subscription. The subscription renews automatically for you. You can choose to cancel the subscription at anytime in your billing settings: https://huggingface.co/settings/billing
...
Compute services usage is billed separately from PRO or Team or Enterprise subscriptions (and potential private storage).
