...
<div class="group flex flex-col space-y-2 rounded-xl border border-indigo-100 bg-gradient-to-br from-indigo-50 px-6 py-4 transition-all hover:shadow-xl dark:border-indigo-700">
...
<div class="group flex flex-col space-y-2 rounded-xl border border-red-100 bg-gradient-to-br from-red-50 px-6 py-4 transition-all hover:shadow-xl dark:border-red-700">
...
<div class="group flex flex-col space-y-2 rounded-xl border border-blue-100 bg-gradient-to-br from-blue-50 px-6 py-4 transition-all hover:shadow-xl dark:border-blue-700">
...
<div class="group flex flex-col space-y-2 rounded-xl border border-green-100 bg-gradient-to-br from-green-50 px-6 py-4 transition-all hover:shadow-xl dark:border-green-700">
...
<a class="!no-underline hover:opacity-60 transform transition-all hover:translate-x-px" href="./organizations-main">Organizations</a>
<a class="!no-underline hover:opacity-60 transform transition-all hover:translate-x-px" href="./security-main">Security</a>
<a class="!no-underline hover:opacity-60 transform transition-all hover:translate-x-px" href="./api-main">Hub API Endpoints</a>
</div>
