...
If it's not specified, the Hub will try to automatically detect the library type. This approach is discouraged and repo creators should use the explicit `library_name` as much as possible.
