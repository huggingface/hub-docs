...
- Gate a group of models/datasets (Team or Enterprise)
...
### Gating Group Collections (Team or Enterprise)
...
This feature is reserved for [Team or Enterprise](https://huggingface.co/docs/hub/en/enterprise) subscribers: more information about Gating Group Collections can be found in [our dedicated doc](https://huggingface.co/docs/hub/en/enterprise-gating-group-collections).
