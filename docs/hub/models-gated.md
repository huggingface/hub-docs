...
[Enterprise Plus](https://huggingface.co/contact/sales?from=enterprise) organizations can also use [Publisher Gating](./enterprise-publisher-gating) to automatically reject access requests from specific countries across all of their gated models and datasets.
