...
In some cases, you might also want to modify the default text in the gate heading,content and the text in the button. For those use cases, you can modify `extra_gated_heading`, `extra_gated_content` and `extra_gated_button_content` like this:

```yaml
---
extra_gated_heading: "Acknowledge license to accept the repository"
extra_gated_content: "Our team may take 2-3 days to process your request"
