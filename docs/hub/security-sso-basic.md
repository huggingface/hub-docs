...
<div class="flex justify-center">
	...
	<img class="hidden dark:block" src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/hub/sso/sso-enabled-without-enforcement-dark.png"/>
</div>
