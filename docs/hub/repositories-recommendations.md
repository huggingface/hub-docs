...
- **Repository size**: The total size of the data you're planning to upload. We generally support repositories up to 300GB. However, if you would like to upload hundreds of GBs (or even TBs) of data, you should ask us more storage and provide details of your project. You can contact us at datasets@huggingface.co or on [our Discord](http://hf.co/join/discord).
- **Number of files**:
