...
For private datasets, the Dataset Viewer is a feature available to [PRO users](https://huggingface.co/pricing) and [Enterprise organizations](https://huggingface.co/enterprise).
