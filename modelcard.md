...
- name: {model_id}
  ...
  - task:
    ...
    source:
      name: {source_name}           # Optional. The name of the source for this result. Example: Open LLM Leaderboard.
      url: {source_url}             # Optional. A link to the source for this result. Example: https://huggingface.co/spaces/HuggingFaceH4/open_llm_leaderboard.
---
