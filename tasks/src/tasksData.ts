...
export const TASKS_DATA: Record<PipelineType, TaskData | undefined> = {
	...
	"multiple-choice":                getData("multiple-choice", placeholder),
	...
	"text-retrieval":                 getData("text-retrieval", placeholder),
	...
	"time-series-forecasting":        getData("time-series-forecasting", placeholder),
