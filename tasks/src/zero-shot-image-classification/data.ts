...
const taskData: TaskDataCustom = {
	...
	models: [
		...
		{
			// TO DO: write description
			description: "Robust image classification model trained on  LAION-2B English subset of LAION-5B (https://laion.ai/blog/laion-5b/) using OpenCLIP (https://github.com/mlfoundations/open_clip).",
